...
import { MonitorPlay, Settings, CheckCircle, AlertCircle, ArrowLeft, Eye, EyeOff } from "lucide-react";
        ...
        <div className="min-h-screen bg-[#020617] flex items-center justify-center p-6 overflow-hidden select-none">
            ...
            <div className={clsx(
                ...
                <Link href="/" className="inline-flex items-center gap-2 text-slate-500 hover:text-white transition-colors mb-8 group">
                    ...
                    <span className="text-sm font-bold tracking-widest uppercase">Back to Site</span>
                </Link>
                ...
                <div className="text-center mb-10 space-y-2">
                    ...
                    <p className="text-slate-500 text-[10px] font-bold tracking-[0.4em] uppercase opacity-60">Secure Access Protocol</p>
                </div>
                ...
                <div className={clsx(
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 relative">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group/input">
                                <input
                                    ...
                                    className="w-full bg-slate-950/50 border border-white/10 rounded-2xl p-4 pl-12 pr-12 text-white placeholder:text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all font-medium"
                                />
                                <Settings className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-600 transition-colors group-focus-within/input:text-blue-400" />
                                <button
                                    type="button"
                        ...
                        >
                            <span className="relative z-10 tracking-tight">{isAnimating ? "Establishing Link..." : "Authorization"}</span>
                            <div className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></div>
                            {!isAnimating && <CheckCircle className="w-5 h-5 group-hover:translate-x-1 transition-transform" />}
                        </button>
                    </form>

                    <div className="mt-8 pt-8 border-t border-white/5 text-center">
                        <p className="text-slate-500 text-xs font-medium">
                            No account? <Link href="/register" className="text-blue-400 font-bold hover:text-blue-300 transition-colors">Apply for Access</Link>
                        </p>
                    </div>
                </div>
            </div>
            ...
            {success && (
                <div className="fixed inset-0 flex items-center justify-center z-50 animate-in fade-in zoom-in duration-500">
                    <div className="text-center space-y-6">
                        <div className="w-24 h-24 bg-blue-600/20 rounded-full flex items-center justify-center mx-auto animate-bounce shadow-2xl shadow-blue-500/20">
                            <CheckCircle className="w-12 h-12 text-blue-400" />
                        </div>
                        <div className="space-y-2">
                            <h2 className="text-4xl font-black text-white italic tracking-tight">Otentikasi Berhasil</h2>
                            <p className="text-slate-400 font-medium">Membangun koneksi ke terminal dashboard...</p>
                        </div>
                        <div className="w-16 h-1 bg-white/10 mx-auto rounded-full overflow-hidden">
